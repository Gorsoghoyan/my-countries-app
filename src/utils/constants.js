...
// error page
export const ERROR_TITLE = "We couldn't find it...";
export const ERROR_CODE_NUMBER = "404";
export const ERROR_PAGE_BTN = "Go Home";
export const ERROR_PATH_TEXT = "This path was not found` "

// auth
export const BOLD_TEXT = "Countries";
